...
from .views import (api_home, api_login, adicionar_usuario, adicionar_camera, excluir_usuario, excluir_camera, listar_cameras, listar_usuarios, editar_camera, editar_usuario)
